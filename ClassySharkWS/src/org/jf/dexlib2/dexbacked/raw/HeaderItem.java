    ...
    public static SectionAnnotator makeAnnotator(@Nonnull DexAnnotator annotator, @Nonnull MapItem mapItem) {
        return new SectionAnnotator(annotator, mapItem) {
            ...
            protected void annotateItem(@Nonnull AnnotatedBytes out, int itemIndex, @Nullable String itemIdentity) {
                ...
                out.annotate(8, "magic: %s", new Object[]{StringUtils.escapeString(magicBuilder.toString())});
                out.annotate(4, "checksum", new Object[0]);
                out.annotate(20, "signature", new Object[0]);
                out.annotate(4, "file_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                int headerSize = this.dexFile.readInt(out.getCursor());
                out.annotate(4, "header_size: %d", new Object[]{headerSize});
                endianTag = this.dexFile.readInt(out.getCursor());
                out.annotate(4, "endian_tag: 0x%x (%s)", new Object[]{endianTag, HeaderItem.getEndianText(endianTag)});
                out.annotate(4, "link_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "link_offset: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "map_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "string_ids_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "string_ids_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "type_ids_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "type_ids_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "proto_ids_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "proto_ids_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "field_ids_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "field_ids_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "method_ids_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "method_ids_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "class_defs_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "class_defs_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "data_size: %d", new Object[]{this.dexFile.readInt(out.getCursor())});
                out.annotate(4, "data_off: 0x%x", new Object[]{this.dexFile.readInt(out.getCursor())});
                if (headerSize > 112) {
